...
namespace UnityEngine.Perception.Randomization.Scenarios
{
    ...
    public abstract class PerceptionScenario<T> : Scenario<T> where T : ScenarioConstants, new()
    {
        ...
        /// </summary>
        protected const string k_ScenarioIterationMetricDefinitionId = "DB1B258E-D1D0-41B6-8751-16F601A2E230";

        /// <summary>
        /// The metric definition used to report the current scenario iteration
        /// </summary>
        protected MetricDefinition m_IterationMetricDefinition;
        ...
        /// </summary>
        protected struct IterationMetricData
        {
